...
# log_file=/home/chronos/user/mount_script.log
...
# echo $data_target_mount
# echo $chroot_target_mount
# echo $linux_target_mount

mount $data_partition $data_target_mount &> /home/chronos/user/mnts.log
mount $chroot_partition $chroot_target_mount &>> /home/chronos/user/mnts.log
mount $linux_partition $linux_target_mount &>> /home/chronos/user/mnts.log
